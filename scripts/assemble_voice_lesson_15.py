...
def main() -> None:
    ...
    ln()
    ln(
        f"**[{house} Readme](../../../../Readme.md) → [{book} content_15.md](../content_15.md) "
        f"→ {page} `lesson_voice_15/voice_lesson_15.md`**"
    )
    ln()
    ln(f"| {zap} Быстрые ссылки |                                                                    |")
    ln("|------------------|--------------------------------------------------------------------|")
    ln(f"| {book} Урок          | [content_15.md](../content_15.md)                                    |")
    ln(f"| {page} Оцифровка     | [lesson_15_digitized.md](../lesson_digitized/lesson_15_digitized.md) |")
    ln()
