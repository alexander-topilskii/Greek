...
def main() -> None:
    ...
    ln()
    ln(
        f"**[{house} Readme](../../../../Readme.md) → [{book} content_18.md](../content_18.md) "
        f"→ {page} `lesson_voice_18/voice_lesson_18.md`**"
    )
    ln()
    ln(f"| {zap} Быстрые ссылки |                                                                    |")
    ln("|------------------|--------------------------------------------------------------------|")
    ln(f"| {book} Урок          | [content_18.md](../content_18.md)                                    |")
    ln(f"| {page} Оцифровка     | [lesson_18_digitized.md](../lesson_digitized/lesson_18_digitized.md) |")
    ln()
