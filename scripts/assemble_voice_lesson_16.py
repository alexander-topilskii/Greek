...
def main() -> None:
    ...
    ln()
    ln(
        f"**[{house} Readme](../../../../Readme.md) → [{book} content_16.md](../content_16.md) "
        f"→ {page} `lesson_voice_16/voice_lesson_16.md`**"
    )
    ln()
    ln(f"| {zap} Быстрые ссылки |                                                                    |")
    ln("|------------------|--------------------------------------------------------------------|")
    ln(f"| {book} Урок          | [content_16.md](../content_16.md)                                    |")
    ln(f"| {page} Оцифровка     | [lesson_16_digitized.md](../lesson_digitized/lesson_16_digitized.md) |")
    ln()
