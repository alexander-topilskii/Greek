...
def main() -> None:
    ...
    ln()
    ln(
        f"**[{house} Readme](../../../../Readme.md) → [{book} content_20.md](../content_20.md) "
        f"→ {page} `lesson_voice_20/voice_lesson_20.md`**"
    )
    ln()
    ln(f"| {zap} Быстрые ссылки |                                                                    |")
    ln("|------------------|--------------------------------------------------------------------|")
    ln(f"| {book} Урок          | [content_20.md](../content_20.md)                                    |")
    ln(f"| {page} Оцифровка     | [lesson_20_digitized.md](../lesson_digitized/lesson_20_digitized.md) |")
    ln()
