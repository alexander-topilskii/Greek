...
| 10 ο; η; το; | 10 ο; η; το; |
| 2 Ρωτάω κάποιον, όπως στο παράδειγμα. | 2 спрашиваю кого-то, как в примере |
| 2.0 Αντιστοιχίζω όπως στο παράδειγμα. | 2.0 сопоставляю как в примере |
| 2.1 ε ή η; | 2.1 ε или η? |
...
| 5 Βάζω το μένω. | 5 вставляю «μένω» |
| 6 Βάζω το σωστό. | 6 вставляю правильное |
| 7 Συμπληρώνω ο, η, το. | 7 дополняю ο, η, το |
| 8 Βάζω ✓ στους αριθμούς που ακούω. | 8 ставлю ✓ у слышимых чисел |
| 9 Διαβάζω τους αριθμούς των λεωφορείων της Θεσσαλονίκης. | 9 читаю номера автобусов Салоник |
