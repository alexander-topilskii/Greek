...
*Тема **«Πού μένεις;»**: жильё, адрес, телефон, род существительного, числа 11–101. **Грамматика, фразы, эталоны** — в этом файле; **словарь урока** (таблицы и итоговая лексика) — в [lexicon.md](lexicon.md). **Порядок:** цели → грамматика → фразы и диалоги → эталоны → словарь.*
