...
*Тема **«Μιλάς ελληνικά;»**: языки (**μιλάω** + **-ικά**), национальность, винительный **τον/την/το**, числа. Материал **самодостаточен** для повторения: правила, фразы, эталоны, словарь. **Порядок:** цели → грамматика → фразы и диалоги → эталоны → словарь.*
