...
| Нельзя | Лучше |
|--------|--------|
| Язык без **μιλάω** в нужной форме | **Μιλάω ρωσικά.** (язык часто ср. мн. название языка) |
| Путать имен. и вин. после **ξέρω** | **Ο Πέτρος** — им.; **ξέρω τον Πέτρο** — вин. |
| **εκατό ένα** вместо 101 | **εκατόν ένα** |
...
*Опоры для текста о друге (форма в учебнике):* см. [digitized/58.md](digitized/58.md) — поле **ΞΕΝΕΣ ΓΛΩΣΣΕΣ** и образец заполнения; в конспекте ниже — эталоны и ключи к выбранным упражнениям.

## 📖 Эталоны для самопроверки

*Готовые формы для сверки — не полный ключ ко всем номерам. Условия упражнений на страницах — в [digitized/48.md](digitized/48.md)–[digitized/58.md](digitized/58.md).*
...
Совпадает с **📌**: **μιλάω** + язык; национальности; **τον/την/το** с **ξέρω** и др.; числа 10–1000 по правилам урока.
