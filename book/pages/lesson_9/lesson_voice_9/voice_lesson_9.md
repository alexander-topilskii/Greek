# 🎙 Голосовой урок 9 — разговорная отработка

**[🏠 Readme](../../../../Readme.md) → `book/pages` → [content_9.md](../content_9.md) → 📄 `voice_lesson_9.md`**
...
* 🎯 **Чек-лист для ситуации:**
  ...
  - *Χρειάζεστε βοήθεια; · Τι νούμερο φοράτε; · Αυτό σας αρέσει; · Δοκιμάζετε αυτό εδώ; · Σας κάνει; · Με γεια σας!* — Фразы продавца из «Πώς το λένε».
...
*Примеры **μου αρέσει / μας αρέσουν** — про «нравится», не про наличие — вынесены в блок 2.*
...
* **Роль А:** Разыграйте сценарий покупателя по готовому тексту (витрина, размер, что нравится/не нравится).
...
* 🎯 **Чек-лист для ситуации:**
  ...
  - *Ένας κύριος / μια κυρία θέλει ένα άσπρο πουκάμισο. Αυτό που του / της αρέσει το έχω μόνο σε πράσινο και γαλάζιο. Υπάρχει ένα άλλο σε άσπρο, αλλά κάνει 90 ευρώ.* — Сценарий 2: продавец (90 €).
...
**«Нравится» — αρέσει / αρέσουν** *(отдельно от вопросов про наличие)*

* *Ενικός:* μου **αρέσει** ο κινηματογράφος · η θάλασσα · το βιβλίο — *мне нравится кино · море · книга.*
* *Πληθυντικός:* μας **αρέσουν** οι χοροί · οι τυρόπιτες · τα σουβλάκια — *нам нравятся танцы · сырные пирожки · сувлаки.*
