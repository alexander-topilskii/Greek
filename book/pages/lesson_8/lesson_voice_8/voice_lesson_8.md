# 🎙 Голосовой урок 8 — разговорная отработка

**[🏠 Readme](../../../../Readme.md) → `book/pages` → [content_8.md](../content_8.md) → 📄 `voice_lesson_8.md`**
...
* 🎯 **Чек-лист для ситуации:**
  ...
  - *Ορίστε.* — Вот, держите. / Пожалуйста (при передаче).
  - *– Τι θα ήθελες; – Θα ήθελα …* — Чего бы ты хотела? — Я бы хотела …
  - *Πόσο έχουν;* — Сколько выходит? / Сколько стоит всё вместе?
  - *Ευχαριστώ. Να ’σαι καλά.* — Спасибо. Будь здорова.
...
* 🎯 **Чек-лист для ситуации:**
  ...
  - *Τα μήλα πόσο τα έχεις;* — По чём у тебя яблоки? / Сколько стоят яблоки?
...
* **Πόσους χυμούς θέλετε;** — *Сколько соков вы хотите?*
* **Θα ήθελα …** — *Я бы хотел(а) …*
* **Δύο χυμούς, τρεις σοκολάτες και τέσσερα παγωτά.** — *Два сока, три шоколадки и четыре мороженых.*
* **Τα ρέστα σας και η απόδειξή σας.** — *Ваша сдача и ваш чек.*
* **ένας, μία, ένα** — *один, одна, одно* *(неопределённый артикль / числительное «один»)*
...
| οι μοσχαρίσιες μπριζόλες | телятина отбивные |
| η φέта | фета |
| οι ελιές | оливки |
| η σάλτσα | соус |
| τα αυγά | яйца |
