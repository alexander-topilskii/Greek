...
* **Контекст:** Встреча со взрослым мужчиной: младший обращается вежливо (**σας**, **κύριε**), старший отвечает тепло и неформально (**σου**, ласковое **… μου**).
...
* **Роль Б (у класса):** Ответьте на приветствие неформально → дальше поддерживайте тот же смысл и этикет, что в чек-листе ниже: имя, **χαίρω πολύ**, страна и встречный вопрос **Εσύ από πού είσαι;**.
...
* **Контекст:** Короткая проверка личности после **Γεια** — уточняете, тот ли это человек по имени.
* **Роль А:** Кратко поздоровайтесь → спросите, не тот ли это человек по имени.
* **Роль Б:** Ответьте отрицанием и назовите своё имя — опирайтесь на чек-лист ниже.
* 🎯 **Чек-лист для ситуации:**
  - *Γεια.* — Привет.
...
**Чтение: сочетания αυ, ευ** *(тренировка правила: перед глухими согласными иначе, чем перед гласными и звонкими)*
...
**Чтение: μπ, ντ, γκ, τσ, τζ** *(опорные слова блока про согласные)*
...
**Ударение: минимальные пары** *(τόνος меняет смысл)*

* **πότε** — *когда?* · **ποτέ** — *никогда*
* **τάξη** — *класс* · **ταξί** — *такси*
* **σχολείο** — *школа* · **σχόλιο** — *замечание*
* **γράφει** — *пишет* · **γραφή** — *письмо*

**Числа для хора** *(0–10, без перевода — только произношение)*
