...
*Седьмая **тематическая единица** курса («**Ποτέ την Κυριακή**»). Материал **самодостаточен** для повторения: правила, фразы, эталоны, словарь. **Порядок:** цели → грамматика → фразы и диалоги → эталоны → словарь.*
