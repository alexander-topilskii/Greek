...
- Опционально в `book/pages/lesson_N/` можно добавить **`essence_N.md`** — сводка лексики и фраз с переводом; при наличии файла генератор добавит строку «💎 Суть урока» в быстрые ссылки `content_N.md`.
